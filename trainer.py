...
from net.rcnn_nms_op    import rcnn_nms, draw_rcnn_nms, draw_rcnn, rcnn_result
...
def load_dummy_datas(num_frames):
    ...
    for n in range(num_frames):
        ...
        rgb   = cv2.imread('/root/sharefolder/sdcnd/didi-udacity-2017/data/rgb/rgb_%05d.png'%n,1)
        lidar = np.load('/root/sharefolder/sdcnd/didi-udacity-2017/data/lidar/lidar_%05d.npy'%n)
        top   = np.load('/root/sharefolder/sdcnd/didi-udacity-2017/data/top/top_%05d.npy'%n)
        front = np.zeros((1,1),dtype=np.float32)
        gt_label  = np.load('/root/sharefolder/sdcnd/didi-udacity-2017/data/gt_labels/gt_labels_%05d.npy'%n)
        gt_box3d = np.load('/root/sharefolder/sdcnd/didi-udacity-2017/data/gt_boxes3d/gt_boxes3d_%05d.npy'%n)


        top_image   = cv2.imread('/root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_image_%05d.png'%n,1)
        front_image = np.zeros((1,1,3),dtype=np.float32)
