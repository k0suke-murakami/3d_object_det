...
if __name__ == '__main__':
    ...
    # import os
    # os.exit()
    basedir = '/root/sharefolder/sdc-data/kitti_laser'
    date  = '2011_09_26'
    drive = '0005'
    ...
    tracklet_file = '/root/sharefolder/sdc-data/kitti_laser/2011_09_26/tracklet_labels.xml'
    ...
    if 1:  ## rgb images --------------------
        ...
        for n in range(num_frames):
            ...
            cv2.imwrite('/root/sharefolder/sdcnd/didi-udacity-2017/data/rgb/rgb_%05d.png'%n,rgb)
    ...
    if 1:  ## top images --------------------
        ...
        for n in range(num_frames):
            ...
            np.save('/root/sharefolder/sdcnd/didi-udacity-2017/data/lidar/lidar_%05d.npy'%n,lidar)
            np.save('/root/sharefolder/sdcnd/didi-udacity-2017/data/top/top_%05d.npy'%n,top)
            cv2.imwrite('/root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_image_%05d.png'%n,top_image)
    ...
    if 1:  ## boxes3d  --------------------
        ...
        for n in range(num_frames):
            ...
            np.save('/root/sharefolder/sdcnd/didi-udacity-2017/data/gt_boxes3d/gt_boxes3d_%05d.npy'%n,gt_boxes3d)
            np.save('/root/sharefolder/sdcnd/didi-udacity-2017/data/gt_labels/gt_labels_%05d.npy'%n,gt_labels)
    ...
    if 1: ## make mean
        ...
        for n in range(num_frames):
            print(n)
            print ('/root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_image_%05d.png'%n)
            top_image = cv2.imread('/root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_image_%05d.png'%n,0)
            mean_image += top_image.astype(np.float32)

        mean_image = mean_image/num_frames
        cv2.imwrite('/root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_mean_image.png',mean_image)
    ...
    if 1: ## gt_3dboxes distribution ... location and box, height
        ...
        aspects=[]
        scales =[]
        mean_image = cv2.imread('/root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_mean_image.png',0)

        for n in range(num_frames):
            print(n)
            gt_boxes3d = np.load('/root/sharefolder/sdcnd/didi-udacity-2017/data/gt_boxes3d/gt_boxes3d_%05d.npy'%n)
        ...
        np.savetxt('/root/sharefolder/sdcnd/didi-udacity-2017/data/depths.txt',depths)
        np.savetxt('/root/sharefolder/sdcnd/didi-udacity-2017/data/aspects.txt',aspects)
        np.savetxt('/root/sharefolder/sdcnd/didi-udacity-2017/data/scales.txt',scales)
        cv2.imwrite('//root/sharefolder/sdcnd/didi-udacity-2017/data/top_image/top_rois.png',mean_image)
